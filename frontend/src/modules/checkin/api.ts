// ============================================================================
// modules/checkin/api.ts
// ----------------------------------------------------------------------------
// Todas las llamadas de este módulo pasan por el API Gateway, nunca
// directo al microservicio de checkin. El Gateway es quien enruta
...
export async function ejemploFetch() {
  ...
  if (!res.ok) {
    throw new Error("Error al conectar con el módulo de checkin a través del Gateway");
  }
  return res.json();
}
